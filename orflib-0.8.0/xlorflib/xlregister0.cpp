...
// Register the function ORF.TRANS
XLRegistration::Arg OrfTransposeArgs[] = {
  { "Range", "Range", "XLF_OPER" }
};
XLRegistration::XLFunctionRegistrationHelper regOrfTrans(
  "xlOrfTranspose", "ORF.TRANS", "Transposes a range",
  "ORFLIB", OrfTransposeArgs, 1);

// Register the function ORF.HCAT
XLRegistration::Arg OrfHorzCatArgs[] = {
  { "Range1", "First Range", "XLF_OPER" },
  { "Range2", "Second Range", "XLF_OPER" }
};
XLRegistration::XLFunctionRegistrationHelper regOrfHorzCat(
  "xlOrfHorzCat", "ORF.HCAT", "Horizontal concatenation of two ranges",
  "ORFLIB", OrfHorzCatArgs, 2);

// Register the function ORF.VCAT
XLRegistration::Arg OrfVertCatArgs[] = {
  { "Range1", "First Range", "XLF_OPER" },
  { "Range2", "Second Range", "XLF_OPER" }
};
XLRegistration::XLFunctionRegistrationHelper regOrfVertCat(
  "xlOrfVertCat", "ORF.VCAT", "Vertical concatenation of two ranges",
  "ORFLIB", OrfVertCatArgs, 2);
