...
namespace {
  ...
  // Register the function ORF.WORSTOFDIGIBSMC
  XLRegistration::Arg OrfWorstOfDigiBSMCArgs[] = {
    { "PayoffType", "1: call; -1: put", "XLF_OPER" },
    { "Strike", "strike", "XLF_OPER" },
    { "FixingTime", "fixing time", "XLF_OPER" },
    { "ExpirationTime", "expiration/payment time", "XLF_OPER" },
    { "Spots", "spots for each asset", "XLF_OPER" },
    { "DiscountCrv", "name of the discount curve", "XLF_OPER" },
    { "DivYields", "dividend yields (cont. cmpd.) for each asset", "XLF_OPER" },
    { "Vols", "volatilities for each asset", "XLF_OPER" },
  ...
  XLRegistration::XLFunctionRegistrationHelper regOrfWorstOfDigiBSMC(
    "xlOrfWorstOfDigiBSMC", "ORF.WORSTOFDIGIBSMC", "Price of a worst-of digital call/put option on a basket of assets in the Black-Scholes model using Monte Carlo.",
    "ORFLIB", OrfWorstOfDigiBSMCArgs, 12);
